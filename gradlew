...
#   (2) The Java Virtual Machine's installation directory must be in your PATH.
#
##############################################################################
...
if [ "$cygwin" = "true" -o "$msys" = "true" ] ; then
    ...
    SEP=""
    for dir in $ROOTDIRSRAW $CLASSPATH; do
...
#   * -D...=... system properties
#   * all other JVM args
# for which do not use an @ file because @-prefixed args will not be left intact.
set -- \
